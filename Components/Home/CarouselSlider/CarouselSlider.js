...
import img1 from '../../../images/gym-img/img1.png';
        ...
        <div className="container mt-5 pt-5">
            <Carousel breakPoints={breakPoints} className="imageHandle">
               <div className="cart">
                   <div>
                        <img src={img1} alt=""/>
                        <Link to="/classes"> <span className="sliderText">PSYCHO TRAINING</span></Link>
                   </div>
               </div>
               <div className="cart">
                   <div>
               ...
               <div className="cart">
                   <div>
                        <img src={img5} alt=""/>
                        <Link to="/classes"><span className="sliderText">STRENGTH TEAINING</span></Link>
                   </div>
               </div>
               <div className="cart">
                   <div>
                        <img src={img6} alt=""/>
                        <Link to="/classes"><span className="sliderText">PYCHO TRAINING</span></Link>
                   </div>
               </div>
